...
class Kohana_Core {
     ...
     * @return void
     */
    public static function location($url, $method = 1, $extend = 2) {
        switch ($method) {
            case 3:
                if (is_int($extend)) {
     ...
     */
    public static function debug($var=NULL, $method = true, $exit = false) {
            if(!defined('DEBUG_EXCEPTION_STATUS')) define('DEBUG_EXCEPTION_STATUS',true);
            $stack = debug_backtrace();
            echo ' <pre>';
            //printf("debug() tiggered at %s : <font color='red'> %s </font>",$stack[0]['file'],$stack[0]['line']);
