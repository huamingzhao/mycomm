...
class Kohana_Kohana_Exception extends Exception {
    ...
    public static $error_view_debug = 'kohana/errordebug';
    ...
    public static function response(Exception $e)
    {
        try
        {
            ...
            if(Kohana::$environment >=30 or (Kohana::$environment < 30 and $request->query("debug") === "1" and in_array($ip, Kohana::$config->load("whitelist.default")))){
                $view = View::factory(Kohana_Exception::$error_view_debug, get_defined_vars());
            }
            else{
                // Instantiate the error view.
                $view = Request::factory("platform/index/error404")->execute();
