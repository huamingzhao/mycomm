...
<table id="__01" width="700" height="588" border="0" cellpadding="0" cellspacing="0" style="margin: 0px auto; font-family:'微软雅黑';">
    ...
    <tr>
        <td colspan="2" width="700" height="230" background="<?php echo URL::webstatic('images/mail_template/mailTemplate_03.png')?>" valign="top">
            ...
            您在一句话网站平台发布的<?php echo $pname?>项目未能通过审核，原因是:<?php echo $des?>。建议您修改完善信息后重新提交。如有疑问可咨询在线客服QQ2885778591或直接拨打4001015908。立即<a href="<?php echo URL::mainsite("/company/member/project/editBasicInfo?project_id={$pid}")?>" style="color: #0b73bb; text-decoration: underline;">完善我的项目信息</a>
