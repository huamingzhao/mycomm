...
<ul class="menu">
    <li class=" <?php if( isset( $nowpage ) && $nowpage==0 ){?>project_home_fc<?php }?>"><a href="javascript:void(0)" title="项目介绍">项目介绍</a></li>
    ...
    <?php if( !empty( $article_list ) ){?>
        <li class="project_home_last <?php if( isset( $nowpage ) && $nowpage>0 ){?>project_home_fc<?php }?> ">
...
<div id="content_text1" class="project_home_content_text project_home_content_text1" <?php if( isset( $nowpage ) && $nowpage>0 ){?>style="display:none;"<?php }?>>
                    ...
                    foreach(array_slice($history_consult2,0,10) as $k=>$v){?>
                        <?php if($v['reply_content'] && $v['reply_time'] && $v['reply_time']<=time()){?>
                            <tr>
                                ...
                                <td width="385"><p class="wt325"><?php echo $v['content'];?></p></td>
                                <td class="c999" width="90"><?php echo $v['time'];?></td>
                            </tr>
                            <tr class="trbor pb">
                                <td width="90">
                                </td>
                                ...
                                <td width="385"><p class="wt325 cf47a20"><?php echo $v['reply_content'];?></p></td>
                                <td class="c999" width="90"><?php echo date('Y-m-d',$v['reply_time']);?></td>
                            </tr>
                        <?php }else{?>
                            <tr class="trbor">
                                <td width="90">
            ...
            <?php foreach($history_consult as $k=>$v){?>
                <?php if($v['reply_content'] && $v['reply_time'] && $v['reply_time']<=time()){?>
                    <tr>
                        ...
                        <td width="325"><p class="wt325"><?php echo $v['content'];?></p></td>
                        <td class="c999" width="325"><?php echo $v['time'];?></td>
                    </tr>
                    <tr class="trbor pb">
                        <td width="90">
                        </td>
...
<?php }?>
<!-- 历史咨询项目详情页面结束 -->
<div id="content_text4" class="project_home_content_text" <?php if( isset( $nowpage ) && $nowpage==0 ){?>style="display:none"<?php }else{?>style="display:block"<?php }?>>
