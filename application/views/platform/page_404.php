...
<div class="main" style="height: auto">
   <div class="error_visit_clum">
       ...
       <div class="error_visit_text">
            ...
            <span>2. 如果您不能确认访问的网址，请浏览一句话 <a href="<?php echo urlbuilder::root('sitemap')?>">网站地图</a> 查看更多项目。</span>
            <span>3. 直接搜索您想要查找的项目：</span>
       ...
       <div class="error_tj_list">
              ...
              <a href="<?php echo urlbuilder:: rootDir ("xiangdao");?>">项目向导</a>
              <a href="<?php echo urlbuilder::fenleiCond();?>">行业分类导航</a>
       </div>
       <div class="clear"></div>
   </div>
   <div class="clear"></div>
