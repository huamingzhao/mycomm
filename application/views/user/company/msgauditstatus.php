                    ...
                    <div class="my_messages" id="my_messages">
                        <div class="mess_nav">
                            <ul>
                                ...
                                <li class="current"><a style="height:50px; display:block" href="<?=URL::website("company/member/msg/auditstatus")?>">审核消息<span id="audit_top_tips_count"><!-- 消息条数 --></span></a></li>
                                ...
                                <li><a style="height:50px; display:block" href="<?=URL::website("company/member/msg/integrity")?>">诚信指数消息<span id="integrity_top_tips_count"></span></a></li>
                            </ul>
                        </div>
                        ...
                        <?php }else{?>
                        <div class="delete_all"><a href="<?php echo URL::website("company/member/msg/delall?group=audit")?>">删除此页面所有消息</a></div>
                        <div class="mess_num">
                            <?php
