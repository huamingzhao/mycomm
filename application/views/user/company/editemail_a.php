...
<div class="right">
    ...
    <div class="user_change_mail">
            ...
            <FORM action='<?php echo URL::website('/company/member/basic/editMailB')?>' method="post" id="fo1">
            ...
            <div class="change_content change_code">
                ...
                <img width="87" height="25" src="<?php echo common::verification_code();?>" id="vfCodeImg1"/><a href="javascript:void(0)" id="changeCodeImg" >看不清换一张</a>
...
function goto_submit(){
    ...
    if( rt==0 ){
        $("#fo1").action= '/company/member/basic/editMailB';
        $("#fo1").method= "post";
        $("#fo1").submit();
    }
}
