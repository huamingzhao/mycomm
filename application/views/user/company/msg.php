...
#my_messages .mess_nav ul li a span {color: #000;}
    ...
    <h2 class="user_right_title"><span>我的消息</span><div class="clear"></div></h2>
                    <div class="my_messages" id="my_messages">
                        <div class="mess_nav">
                            <ul>
                                <li class="current"><a style="height:50px; display:block" href="<?=URL::website("company/member/msg")?>">名片消息<span id="cards_top_tips_count"></span></a></li>
                                ...
                                <li><a href="<?=URL::website("company/member/msg/account")?>">账户消息</a><span id="account_top_tips_count"><!-- 消息条数 --></span></li>
                                <li><a href="<?=URL::website("company/member/msg/integrity")?>">诚信指数消息</a><span id="integrity_top_tips_count"></span></li>
                            </ul>
                        </div>
                        ...
                        <?php }else{?>
                        <div class="delete_all"><a href="<?php echo URL::website("company/member/msg/delall?group=cards")?>">删除此页面所有消息</a></div>
                        <div class="mess_num">
                            <?php
