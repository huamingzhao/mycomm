                    ...
                    <div class="my_messages"  id="my_messages">
                        <div class="mess_nav">
                            <ul>
                                ...
                                <li class="current"><a style="height:50px; display:block" href="<?=URL::website("company/member/msg/account")?>">账户消息<span id="account_top_tips_count"><!-- 消息条数 --></span></a></li>
                        ...
                        <?php }else{?>
                        <div class="delete_all"><a href="<?php echo URL::website("company/member/msg/delall?group=account")?>">删除此页面所有消息</a></div>
                        <div class="mess_num">
                            <?php
