            ...
            <div class="telContent">
                <div class="telYz">
                     <div class="telSucceed">
                        <h4>手机验证成功！</h4>
                        <p><span>已绑定手机：</span><em style="font-style:normal;"><?=$mobile?></em><a style="padding-left:10px; color:#f00;"  href="<?php echo URL::website("person/member/valid/mobile?to=change")?>">修改手机号</a></p>
                     </div>
                </div>
            </div>
        </div>
