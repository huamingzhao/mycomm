...
<?php echo URL::webjs("del_shenhe.js")?>
            ...
            <div id="right">
        <div id="right_top"><span>安全中心</span><div class="clear"></div></div>
                    <div style="padding-left:19px; padding-top:10px;" id="right_con">
                       <div class="ryl_safe_center">
                        ...
                        <li>
                            ...
                            <a href="<?php echo URL::website('person/member/basic/modifypassword')?>" class="safe_link_01">修改</a>
                            <div class="clear"></div>
                        </li>
                        ...
                        <li>
                            ...
                            <?php }else{?>
                                <?php if( $valid_email=='1' ){?>
                                    <a href="/person/member/basic/editMail" class="safe_link_01">修改</a>
                                <?php }else{?>
                                    <a href="/person/member/basic/setEmail" class="safe_link_01">去验证</a>
                                <?php }?>
                            <?php }?>
                            <!-- 很抱歉，邮箱最多只能修改2次！如有疑问请拨打客服电话400 1015 908-->
                            <div class="clear"></div>
                        </li>
                        ...
                        <li>
                            ...
                            ?>
                                <em>通过验证可增强诚信度，方便与企业沟通</em>
                                 </p>
                                <a href="<?php echo URL::website('person/member/valid/mobile')?>" class="safe_link_03">去验证</a>
                            <?php
                            ...
                            ?>
                                ...
                                <a href="<?php echo URL::website('person/member/valid/mobile?to=change')?>" class="safe_link_03">修改</a>
                            <?php
                            }
                            ?>
                            <div class="clear"></div>
