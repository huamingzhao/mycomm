...
#my_messages .mess_nav ul li a span {color: #000;}
                ...
                <div class="right"  style="height:auto !important;height:620px;min-height:620px;">
                    ...
                    <div class="my_messages" id="my_messages">
                        <div class="mess_nav">
                            <ul>
                                <li style="width:364px;"><a style="height:50px; display:block" href="<?=URL::website("person/member/msg")?>">名片消息<span id="cards_top_tips_count"></span></a></li>
                                <li class="current" style="width:364px;"><a style="height:50px; display:block" href="<?=URL::website("person/member/msg/auditstatus")?>">审核消息<span id="audit_top_tips_count"></span></a></li>
                            </ul>
                        </div>
                        ...
                        <?php }else{?>
                        <div class="delete_all"><a href="<?php echo URL::website("person/member/msg/delall?group=audit")?>">删除此页面所有消息</a></div>
                        <div class="mess_num">
                            <?php
