                        ...
                        <!--我收藏的文章-->
                         <div class="infor_newlist">
                          ...
                          <li class="tougao_ht" id="show_tougao_<?php echo $v->article_id?>">
                            <h3>
                               <a target="_blank" class="tougao_ht_title"  href="<?php if($v->article_status==2){echo zxurlbuilder::zixuninfo($v->article_id,date("Ym",$v->article_intime));}else{echo URL::site('/member/showzixun?id='.$v->article_id);}?>" title="<?=$v->article_tag?>">
                <?php
