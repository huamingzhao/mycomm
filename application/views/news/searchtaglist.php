<div class="infor_center ad-pt">
            ...
            <?php foreach ($list as $k=>$v){
              ...
              <li>
                <h3>
                    <a target="_blank" href="<?php if($v->parent_id != 29){echo zxurlbuilder::zixuninfo($v->article_id,date("Ym",$v->article_intime));}else{echo zxurlbuilder::porjectzixuninfo(zixun::getZxPorjectId($v->article_id),$v->article_id);}?>" title=""><?php echo $org_art_name;?></a>
                    <?php if ($v->article_recommend==1){?><em></em><?php }?>
                </h3>
